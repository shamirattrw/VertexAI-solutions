...
import { Calendar, ArrowRight, Users, Clock, Target } from 'lucide-react';
...
const GetStarted = () => {
  ...
  return (
    <section id="get-started" className="py-20 bg-light-navy">
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
            <div className="flex items-center justify-center space-x-3 p-4 bg-mint-green/5 border border-mint-green/20 rounded-lg">
              ...
              <span className="text-mint-green font-inter font-medium">Pilot Client Pricing</span>
            </div>
            <div className="flex items-center justify-center space-x-3 p-4 bg-mint-green/5 border border-mint-green/20 rounded-lg">
              <Clock className="h-5 w-5 text-mint-green" />
              <span className="text-mint-green font-inter font-medium">Priority Support</span>
            </div>
            <div className="flex items-center justify-center space-x-3 p-4 bg-mint-green/5 border border-mint-green/20 rounded-lg">
              <Target className="h-5 w-5 text-mint-green" />
              <span className="text-mint-green font-inter font-medium">Custom Solutions</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-dark-navy p-8 rounded-2xl border border-mint-green/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label htmlFor="company" className="block text-sm font-medium text-text-gray mb-2">
                  Company Name
                </label>
                <input
                  type="text"
              ...
              <button
                type="submit"
                className="w-full bg-mint-green text-dark-navy px-8 py-4 rounded-lg font-semibold text-lg hover:bg-mint-green/90 hover:scale-[1.02] transform transition-all duration-200 flex items-center justify-center group"
              >
          ...
          <div className="space-y-8">
            <div className="bg-dark-navy p-8 rounded-2xl border border-mint-green/20">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-poppins font-medium text-white">Discovery Call (30 min)</h4>
                    <p className="text-text-gray text-sm">We'll discuss your current processes and identify automation opportunities</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-poppins font-medium text-white">Custom Proposal</h4>
                    <p className="text-text-gray text-sm">Receive a detailed plan with transparent pricing within 48 hours</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-poppins font-medium text-white">Development & Testing</h4>
                    <p className="text-text-gray text-sm">We build and test your solution with regular check-ins</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-mint-green/10 p-6 rounded-xl border border-mint-green/30">
              <h3 className="font-poppins font-semibold text-white mb-3">Pilot Program Benefits</h3>
