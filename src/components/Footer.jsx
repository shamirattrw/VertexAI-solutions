        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-text-gray font-inter mb-6 leading-relaxed">
              Designing ethical, transparent AI tools to simplify your
              workflows—no hype, just results.
            </p>
            <div className="flex items-center space-x-4 mb-4">
              <Mail className="h-5 w-5 text-mint-green" />
              <span className="text-text-gray font-inter">
                aslanshamir@aigroo.cloud
              </span>
            </div>
            <div className="flex items-center space-x-4">
              <Phone className="h-5 w-5 text-mint-green" />
              <span className="text-text-gray font-inter">+91 94771 72214</span>
            </div>
          </div>
        ...
        <div className="border-t border-mint-green/20 mt-12 pt-8">
          <div className="bg-mint-green/5 border border-mint-green/20 rounded-lg p-6 mb-6">
            ...
            <p className="text-text-gray font-inter text-sm leading-relaxed">
              VertexAI Solutions is a new agency focused on delivering
              measurable results. All projects include a 30-day satisfaction
              guarantee. We believe in transparent communication and will never
              make unrealistic promises about timeline or outcomes.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <a
                href="#"
                className="text-text-gray hover:text-mint-green text-sm font-inter transition-colors"
              >
                Privacy Policy
              </a>
              <a
